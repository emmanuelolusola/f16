...
const HomeLanding = () => {
  ...
  return (
    <div className="w-full h-[100dvh] py-[100px] lg:py-[140px] flex flex-col justify-end items-center gap-[20dvh] lg:gap-[18vh]">
      <img src={gif} alt="" className="w-[100px] lg:w-[150px]" />
      <div className="flex flex-col items-center gap-[60px] lg:gap-20">
        <p className="text-[18px] text-center px-[32px]">
